# $Id: Makefile,v 1.7 2004/02/09 11:49:07 mathie Exp $
#
# $Log: Makefile,v $
# Revision 1.7  2004/02/09 11:49:07  mathie
# * Clean up files created by kata6.
# * Build kata9.
#
...
TARGETS = kata2 kata4 kata5 kata6 kata9
DEBUG = yes
...
clean:
	rm -f $(TARGETS) *.o *~
	rm -f wordlist.out maindict.out
